  ...
  return (
    ...
    >
      ...
      <div className="p-5 flex-1 flex flex-col">
        ...
        <p className="text-base text-muted-foreground mb-4 flex-1 line-clamp-3 leading-relaxed">
          {description}
        </p>
        ...
        <div className="flex flex-wrap gap-2 mb-4">
          {technologies.split(', ').slice(0, 4).map((tech, idx) => (
            <span
              key={idx}
              className={`px-2.5 py-1 text-sm font-medium rounded-md border transition-all duration-300 hover:scale-105 ${
                statusStyle
        ...
        <div className="flex items-center gap-4 pt-3 border-t border-border">
          {projectLink && (
            <a
              ...
              className="flex items-center gap-2 text-base font-medium text-muted-foreground hover:text-primary transition-all duration-300 hover:translate-x-0.5"
            >
