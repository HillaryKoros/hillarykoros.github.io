...
import { calculateAge, animateValue } from '../lib/utils';
...
const Sidebar: React.FC = () => {
  ...
  const professionalTitles = [
    ...
    "Flood Early Warning · Earth Observation",
    "Cloud-Native & DevOps"
  ];
    ...
    >
      <div className="bg-card rounded-3xl shadow-lg border-2 border-border p-6 sm:p-8">
        ...
        <div className={`flex ${isMobile ? 'flex-row items-center' : 'flex-col items-center'}`}>
          <motion.div
            className={`${isMobile ? 'w-20 h-20 mr-4' : 'w-28 h-28 mb-4'} rounded-full overflow-hidden border-4 border-primary/20 shadow-lg`}
          ...
          <div className={`${isMobile ? 'text-left' : 'text-center w-full'}`}>
            ...
            <a
              ...
              className="text-[11px] font-semibold uppercase tracking-wider text-muted-foreground hover:text-foreground transition-colors block mb-2"
            >
              GIS Researcher &amp; Engineer · ICPAC
            </a>
        ...
        <motion.button
          className="w-full flex items-center justify-center py-2.5 mt-5 text-xs font-semibold text-muted-foreground bg-secondary/50 rounded-lg hover:bg-secondary transition-colors"
            ...
            >
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  <div className="w-9 h-9 flex items-center justify-center rounded-lg bg-secondary">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-semibold">{age} years old</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <address className="text-sm font-semibold not-italic">Nairobi, Kenya</address>
                  </div>
                </div>
